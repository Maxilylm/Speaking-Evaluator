    ...
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="mt-12 p-6 bg-green-50 border border-green-200 rounded-lg">
        ...
        <ol className="text-sm text-green-600 space-y-1 list-decimal list-inside">
          <li>Add the bot number to your contacts</li>
          <li>Send a voice note with an optional level (e.g. &quot;B2&quot;)</li>
          <li>Receive your evaluation results instantly</li>
        </ol>
        <p className="text-xs text-green-500 mt-3">
          Requires Twilio WhatsApp sandbox setup. See .env.example for config.
        </p>
      </div>
    </main>
  );
